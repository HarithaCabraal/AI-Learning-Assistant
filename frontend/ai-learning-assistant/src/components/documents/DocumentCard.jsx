...
const DocumentCard = ({ document, onDelete }) => {
    ...
    return <div 
        ...
        >
            {/* Header Section */}
            <div>
                <div classsName="flex items-start justify-between gap-3 mb-4">
            ...
            {/* Hover Indicator */}
            <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/0 to-teal-500/0 group-hover:from-emerald-500/5 group-hover:to-teal-500/5 transition-all duartion-300 pointer-events-none" />
        </div>
