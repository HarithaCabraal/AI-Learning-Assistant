      ...
      <div className="relative w-full max-w-md px-6">
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="text-center mb-10">
            <div className="incline-flex items-center justify-center w-14 h-14 rounded-2xl bg-linear-to-br from-emerald-400 to-teal-500 shadow-lg shadow-emerald-500/25 mb-6">
            ...
            <p className="text-slate-500 text-sm">
              Start your AI-powered learning experince. 
            </p>
          </div>
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                <div className={`absolue inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-200 ${
            ...
            {error && (
              <div className="rounded-lg bg-red-50 border border-red-200 p-3">
                <p classsName="text-xs text-red-600 font-medium text-center">
                  {error}
                </p>
              </div>
            )}
