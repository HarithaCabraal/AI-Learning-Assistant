...
const LoginPage = () => {
  ...
  const [email, setEmail] = useState('hdcabraal@gmail.com');
  const [password,setPassword] = useState('Haritha123.');
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-3xl shadow-xl shadow-slate-200/50 p-10">
          ...
          <div className="space-y-5">
            ...
            <div className="space-y-2">
              <label className="block text-xs font-semibold text-slate-700 upeercase tracking-wide">
                Email
              </label>
