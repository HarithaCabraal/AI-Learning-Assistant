...
const DashboardPage = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: dashboardDara.overview.totalFlashcards,
      icon: BookOpen,
      gradient: 'from-purple-400 to-pink-500',
      shadowColor: 'shadow-pirple-500/25'
    },
    {
      label: 'Total Quizzes',
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-medium ttext-slate-900 tracking-tight mb-2">
            Dashboard
          </h1>
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-xl shadow-slate-200/50 p-8">
          <div className="flex items-center gap-3 mb-6">
            ...
            <h3 classsName="text-xl font-medium text-slate-900 tracking-tight">
              Recent Activity
            </h3>
          </div>
