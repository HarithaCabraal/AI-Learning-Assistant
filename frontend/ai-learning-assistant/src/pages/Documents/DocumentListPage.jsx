...
const DocumentListPage = () => {
  ...
  const [uploadTitle, setUplaodTitle] = useState("");
  const [uploading, setUploading] = useState(false);

  // State for delete confirmation modal
  const [isDeleteModalOpen, setIsDeleteModalOpen] = useState(false);
  const [deleting, setDeleting] = useState(false);
  const [selectedDoc, setSlectedDoc] = useState(null);
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      setUploadFile(file);
      setUplaodTitle(file.name.replace(/\.[^/.]+$/,""));
    }
  };
      ...
      return (
        <div className="flex items-center justify-center min-h-[400px]">
          <div className="text-center max-w-md">
            <div className="inline-flex ietms-center justify-center w-20 h-20 rounded-2xl bg-linear-to-br from-slate-100 to-slate-200 shadow-lg shadow-slate-200/50 mb-6">
            ...
            <form onSubmit = {handleUpload} className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  type="text"
                  value={uploadTitle}
                  onChange={(e) => setUplaodTitle(e.target.value)}
                  required
