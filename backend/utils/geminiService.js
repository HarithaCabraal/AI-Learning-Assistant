...
if (!process.env.GEMINI_API_KEY) {
    console.error('FATAL ERROR: GEMINI_KEY_API is not set in the environment variables');
    process.exit(1);
}
...
export const chatWithContext = async (question, chunks) => {
    ...
    const prompt = `Based on the following context from a document, Anayse the context and answer the user's question.
