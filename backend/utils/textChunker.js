/**
 * Split text into chuncks for better AI processing
 * @param {string} text - Full text to chunk
 * @param {number} chunckSize - Target size per chunk (in words)
 ...
 * @param {number} maxChunks - maximum chunks to retuen
